<template>
  <div class="slidev-layout cover" :style="style">
    <div class="my-auto w-full">
      ...
      <div class="flex items-center justify-between absolute left-20px right-20px top-10px">
        <img style="height:40px;margin-right:10px" src='../assets/logos/ceplas-claim.svg'/>
        <img style="height:70px; margin-left:-80px" src='../assets/logos/mibinet-logo.svg'/>
        <img style="height:80px" src='../assets/logos/DataPLANT_logo_bg_transparent.svg'/>
      </div>
    </div>
  </div>
</template>
